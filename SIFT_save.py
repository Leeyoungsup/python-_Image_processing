            ...
            for window_colunm in range(4):
                ...
                for window_y in range(4):
                    for window_x in range(4):
                        ...
                        if SIFT_index == 8:
                            SIFT_index = 7
                        SIFT_histogram1[((window_row * 4) + window_colunm) * 8 + SIFT_index] = SIFT_histogram1[((
                                                                                                                            window_row * 4) + window_colunm) * 8 + SIFT_index] + \
                                                                                               window_m[
                                                                                                   window_y, window_x]
...
window = Tk()
filename = tkfile.askopenfilenames(title="Select file", parent=window,
